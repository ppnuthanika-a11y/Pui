...
export const AILogo: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm-2.25 2.25a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5ZM12.25 15a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5ZM18.5 10.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM19.25 15a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5ZM13 19.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm2.5-4.25a.75.75 0 0 0-1.5 0v.5a.75.75 0 0 0 1.5 0v-.5ZM13.75 4a.75.75 0 0 0-1.5 0v.5a.75.75 0 0 0 1.5 0v-.5ZM4.75 12a.75.75 0 0 0-1.5 0v.5a.75.75 0 0 0 1.5 0v-.5ZM6 10.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm-.75 4.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM7.5 19.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 0 1-2.25 2.25h-13.5a2.25 2.25 0 0 1-2.25-2.25v-4.07m18-4.22-2.25-2.25a2.25 2.25 0 0 0-3.182 0l-2.25 2.25a2.25 2.25 0 0 1-3.182 0l-2.25-2.25a2.25 2.25 0 0 0-3.182 0l-2.25 2.25m18 0-2.25 2.25m0 0-2.25-2.25m-10.5 0 2.25 2.25m0 0 2.25 2.25m0 0 2.25-2.25m-2.25-2.25L12 9.75l-2.25-2.25" />
  </svg>
);
...
export const AssetIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 15h7.5M12 11.25V15" />
    </svg>
);